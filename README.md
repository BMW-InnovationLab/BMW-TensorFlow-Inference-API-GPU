...
This container can be deployed using either docker(continue with this documentation) or 

For more information on how to run the API using docker swarm, please refer to [docker swarm documentation](./README-docker_swarm.md) or continue with this documentation to run the API using docker-ce. In case docker swarm is selected, please consider returning to this documentation for further information about the API endpoints as well as the model structure sections.
